...
**Integrator Draft:** v1.7 (Baseline HVAC & Advanced Control Integration)
...
| v1.7 | 2026-01-27 | Added Baseline HVAC Logic, Basalte Deseo UI, and verified URLs | **Current** |
...
| [INKNXCAR001I000](https://www.intesis.com/products/ac-gateways/carrier-gateways/carrier-vrf-systems-knx-interface-vrf-in-knx-v1) | Intesis | INT-HVAC-CAR | Carrier/Day&Night to KNX Gateway | 2 | 1 | **Non-UL (SELV)** | Main Heat Pumps |
| [INKNXFGL001R000](https://www.hms-networks.com/products/intesis/fujitsu-rac-and-vrf-to-knx-interface-with-binary-inputs-to-cn-connector) | Intesis | INT-HVAC-FUJ | Fujitsu to KNX Interface | 1 | 1 | **Non-UL (SELV)** | Tech Room Mini-Split |
| [JAL-0810.02](https://www.mdt.de/en/products/product-detail/actuators/shutter-actuators/shutter-actuators-jal.html) | MDT | MDT-JAL-0810 | 8-fold Shutter Actuator (24V DC) | 1 | 1 | **Non-UL (SELV)** | Motorized Skylights |
...
| [Deseo KNX](https://www.basalte.be/en/products/deseo) | Basalte | BAS-DESEO | Basalte Deseo (OLED Thermostat) | 1 | 1 | **KNX Certified** | Hallway Central UI |
| [9011-02](https://www.basalte.be/en/product/sentido) | Basalte | BAS-BUS-COU | KNX Bus Coupler for UI Units | 13 | 1 | **KNX Certified** | For Sentido & Deseo |
...
| [SR-2401-10V](https://www.sunricher.com/dali-to-0-10v-pwm-sr-2303-0-10v-pwm.html) | Sunricher | SUN-2401-10V | DALI to 0-10V Signal Converter | 2 | 1 | **UL Recog.** | Speed Control |
...
| [SR-2401-10V](https://www.sunricher.com/dali-to-0-10v-pwm-sr-2303-0-10v-pwm.html) | Sunricher | SUN-2401-10V | DALI to 0-10V Signal Converter | 4 | 1 | **UL Recog.** | Speed Control |
