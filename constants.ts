...
export const INITIAL_MODULES: HardwareModule[] = [
  ...
  {
    id: 'lcp2-enc-top',
    name: 'Leviton 47605-42W',
    manufacturer: 'Leviton',
    description: '42" Structured Media Enclosure (Steel) (Automation / KNX / DALI)',
    type: ModuleType.ENCLOSURE,
    ...
    powerWatts: 0,
    quantity: 1,
    url: 'https://store.leviton.com/products/smc-structured-media-enclosure-with-cover-42-inch-white-47605-42w',
    dimensions: { width: 15.62, height: 43.32, depth: 3.68, unit: 'in' },
    location: 'LCP-2 (Automation)',
    notes: 'Top box in double-stack. Steel construction. 42.16"H x 14.38"W x 3.60"D (enclosure). Capacity: up to 12 modules. Drill 2" pass-through to lower box.',
    position: { x: 35, y: 55 }
  },
  {
    id: 'lcp2-enc-bottom',
