    ...
    <div className="h-full overflow-y-auto p-6 space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
        <div className="bg-slate-900 p-6 rounded-xl border border-slate-800 shadow-lg relative overflow-hidden group">
          ...
          <p className="text-slate-300 text-xs mt-1">Excludes Tax & Labor</p>
        </div>
      ...
      <div className="grid grid-cols-1 xl:grid-cols-3 gap-6 min-h-[600px]">
        ...
        <div className="xl:col-span-2 bg-slate-900 rounded-xl border border-slate-800 flex flex-col overflow-hidden shadow-lg">
          <div className="px-6 py-4 border-b border-slate-800 bg-slate-900/50 flex justify-between items-center">
            <div className="flex items-center gap-3">
              ...
              <span className="text-xs text-slate-300 bg-slate-800 px-2 py-1 rounded-full">{modules.length} Rows</span>
            </div>
            {sortConfig.length > 0 && (
              <button
                onClick={clearSort}
                className="text-xs flex items-center gap-1 text-slate-200 hover:text-white px-2 py-1 rounded hover:bg-slate-800 transition-colors"
              >
                  ...
                  <tr key={m.id} className="hover:bg-slate-800/50 transition-colors group">
                    ...
                    <td className="px-4 py-3 text-right">
                      <div className="flex items-center justify-end space-x-1">
                        <button onClick={() => updateQuantity(m.id, -1)} className="w-6 h-6 flex items-center justify-center hover:bg-slate-800 rounded text-slate-300 hover:text-white">-</button>
                      ...
                      <div className="flex items-center justify-center space-x-2">
                        {(m.mountType === MountType.DIN_RAIL || m.mountType === MountType.RACK_UNIT) && (
                          <button
                            ...
                            className="p-1.5 text-slate-200 hover:text-blue-400 hover:bg-blue-900/20 rounded transition-colors"
                        ...
                        <button
                          ...
                          className="p-1.5 text-slate-200 hover:text-red-400 hover:bg-red-900/20 rounded transition-colors"
                          title="Delete Item"
                        >
        ...
        <div className="flex flex-col gap-6 h-full overflow-hidden">
          ...
          <div className="flex-1 bg-slate-900 p-4 rounded-xl border border-slate-800 shadow-lg flex flex-col min-h-0">
            <h3 className="text-sm font-bold text-slate-200 uppercase tracking-wider mb-2">Budget Allocation</h3>
        ...
        <div className="absolute inset-0 z-50 bg-slate-950/80 backdrop-blur-sm flex items-center justify-center p-4">
          <div className="bg-slate-900 border border-slate-700 p-6 rounded-2xl w-full max-w-md shadow-2xl">
            ...
            <div className="space-y-3">
              ...
              <div className="flex gap-2">
                <div className="flex-1">
                  <label className="text-[10px] text-slate-300 uppercase">Cost ($)</label>
                ...
                <div className="flex-1">
                  <label className="text-[10px] text-slate-300 uppercase">Size (TE/U)</label>
            ...
            <div className="flex justify-end gap-3 mt-6">
              <button onClick={() => setShowAddModal(false)} className="px-4 py-2 text-slate-200 hover:text-white text-sm">Cancel</button>
